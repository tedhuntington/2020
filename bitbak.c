...
{
#ifdef Linux
lines[0]=XGetImage(xdisplay,pixmap[linpage],hx1,hy1+skin[2]*HF*(mode!=1)+
	 (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),
	 hx1+1+skin[7]*2,hy1+HMAN-4*(mode==1),AllPlanes,ZPixmap);
lines[7]=XGetImage(xdisplay,pixmap[linpage],hx1+ECHX-5-skin[7]*2,hy1+skin[2]*HF*(mode!=4)+
...
if (skin[7]==0)    /*dress*/
  {
#ifdef Linux
   lines[10]=XGetImage(xdisplay,pixmap[linpage],hx1+2,hy1+skin[2]*HF*(mode!=1)+
	 (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),
	 hx1+2,hy1+HMAN-DF,AllPlanes,ZPixmap);
   lines[11]=XGetImage(xdisplay,pixmap[linpage],hx1+ECHX-6,hy1+skin[2]*HF*(mode!=4)+
	     (!(skin[2]==0&&mode==1)&&(skin[2]==0||mode==4))*(NOSEY+7),
	     hx1+ECHX-6,hy1+HMAN-DF,AllPlanes,ZPixmap);
   lines[12]=XGetImage(xdisplay,pixmap[linpage],hx1+3,hy1+skin[2]*HF*(mode!=1)+
	 (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),
	 hx1+3,hy1+HMAN-DF2,AllPlanes,ZPixmap);
   lines[13]=XGetImage(xdisplay,pixmap[linpage],hx1+ECHX-7,hy1+skin[2]*HF*(mode!=4)+
	     (!(skin[2]==0&&mode==1)&&(skin[2]==0||mode==4))*(NOSEY+7),
...
#ifdef Linux
lines[1]=XGetImage(xdisplay,pixmap[linpage],hx1,hy1,hx1+2,hy1+1,AllPlanes,ZPixmap);
lines[2]=XGetImage(xdisplay,pixmap[linpage],hx1+ECHX-7,hy1,hx1+ECHX-4,hy1+1,AllPlanes,ZPixmap);
...
if (skin[2]!=2 || (skin[2]==2 && mode!=2))
  ...
  if (mode!=2 || skin[2]<2)
    {
#ifdef Linux
lines[3]=XGetImage(xdisplay,pixmap[linpage],hx1+3,hy1+BSHIRTY-4,hx1+5,hy1+BSHIRTY-3,AllPlanes,ZPixmap);
lines[4]=XGetImage(xdisplay,pixmap[linpage],hx1+ESHIRTX-7,hy1+BSHIRTY-4,hx1+ESHIRTX-5,hy1+BSHIRTY-3,AllPlanes,ZPixmap);
...
if (mode==1||(skin[2]==0&&mode!=4))
  {
#ifdef Linux
lines[5]=XGetImage(xdisplay,pixmap[linpage],hx1,hy1,hx1,hy1+NOSEY-3,AllPlanes,ZPixmap);
lines[8]=XGetImage(xdisplay,pixmap[linpage],hx1,hy1+NOSEY,hx1,hy1+BSHIRTY-1,AllPlanes,ZPixmap);
...
if (mode==4||(skin[2]==0&&mode!=1))
  {
#ifdef Linux
lines[6]=XGetImage(xdisplay,pixmap[linpage],hx1+ESHIRTX-3,hy1,hx1+ESHIRTX-1,hy1+NOSEY-3,AllPlanes,ZPixmap);
lines[9]=XGetImage(xdisplay,pixmap[linpage],hx1+ESHIRTX-3,hy1+NOSEY,hx1+ESHIRTX-2,hy1+BSHIRTY-1,AllPlanes,ZPixmap);
...
/*shoes*/
#ifdef Linux
lines[14]=XGetImage(xdisplay,pixmap[linpage],hx1,hy1+EPANTSY-1,hx1+3,hy1+ENDBODY-7*(numimg==0)-5*(numimg==1),AllPlanes,ZPixmap);
lines[15]=XGetImage(xdisplay,pixmap[linpage],hx1+ESHIRTX-5,hy1+EPANTSY-1,hx1+ESHIRTX-4+2*(numimg==4),
	 hy1+ENDBODY-7*(numimg==5)-5*(numimg==4),AllPlanes,ZPixmap);
lines[16]=XGetImage(xdisplay,pixmap[linpage],hx1+(ESHIRTX-8)*(numimg==1||numimg==3||numimg==7)+
...
{
#ifdef Linux
lines3[0]=XGetImage(xdisplay,pixmap[linpage],rx3,ry3+skin3[2]*HF*(mode3!=1)+
	 (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),
	 rx3+1+skin3[7]*2,ry3+HMAN-4*(mode3==1),AllPlanes,ZPixmap);
lines3[7]=XGetImage(xdisplay,pixmap[linpage],rx3+ECHX-5-skin3[7]*2,ry3+skin3[2]*HF*(mode3!=4)+
...
if (skin3[7]==0)    /*dress*/
  {
#ifdef Linux
lines3[10]=XGetImage(xdisplay,pixmap[linpage],rx3+2,ry3+skin3[2]*HF*(mode3!=1)+
	 (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),
	 rx3+2,ry3+HMAN-DF,AllPlanes,ZPixmap);
lines3[11]=XGetImage(xdisplay,pixmap[linpage],rx3+ECHX-6,ry3+skin3[2]*HF*(mode3!=4)+
	     (!(skin3[2]==0&&mode3==1)&&(skin3[2]==0||mode3==4))*(NOSEY+7),
	     rx3+ECHX-6,ry3+HMAN-DF,AllPlanes,ZPixmap);
lines3[12]=XGetImage(xdisplay,pixmap[linpage],rx3+3,ry3+skin3[2]*HF*(mode3!=1)+
	 (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),
	 rx3+3,ry3+HMAN-DF2,AllPlanes,ZPixmap);
lines3[13]=XGetImage(xdisplay,pixmap[linpage],rx3+ECHX-7,ry3+skin3[2]*HF*(mode3!=4)+
	     (!(skin3[2]==0&&mode3==1)&&(skin3[2]==0||mode3==4))*(NOSEY+7),
...
#ifdef Linux
lines3[1]=XGetImage(xdisplay,pixmap[linpage],rx3,ry3,rx3+2,ry3+1,AllPlanes,ZPixmap);
lines3[2]=XGetImage(xdisplay,pixmap[linpage],rx3+ECHX-7,ry3,rx3+ECHX-4,ry3+1,AllPlanes,ZPixmap);
...
if (skin3[2]!=2 || (skin3[2]==2 && mode3!=2))
  ...
  if (mode3!=2 || skin3[2]<2)
    {
#ifdef Linux
lines3[3]=XGetImage(xdisplay,pixmap[linpage],rx3+3,ry3+BSHIRTY-4,rx3+5,ry3+BSHIRTY-3,AllPlanes,ZPixmap);
lines3[4]=XGetImage(xdisplay,pixmap[linpage],rx3+ESHIRTX-7,ry3+BSHIRTY-4,rx3+ESHIRTX-5,ry3+BSHIRTY-3,AllPlanes,ZPixmap);
...
if (mode3==1||(skin3[2]==0&&mode3!=4))
  {
#ifdef Linux
lines3[5]=XGetImage(xdisplay,pixmap[linpage],rx3,ry3,rx3,ry3+NOSEY-3,AllPlanes,ZPixmap);
lines3[8]=XGetImage(xdisplay,pixmap[linpage],rx3,ry3+NOSEY,rx3,ry3+BSHIRTY-1,AllPlanes,ZPixmap);
...
if (mode3==4||(skin3[2]==0&&mode!=1))
  {
#ifdef Linux
lines3[6]=XGetImage(xdisplay,pixmap[linpage],rx3+ESHIRTX-3,ry3,rx3+ESHIRTX-1,ry3+NOSEY-3,AllPlanes,ZPixmap);
lines3[9]=XGetImage(xdisplay,pixmap[linpage],rx3+ESHIRTX-3,ry3+NOSEY,rx3+ESHIRTX-2,ry3+BSHIRTY-1,AllPlanes,ZPixmap);
...
/*shoes*/
#ifdef Linux
lines3[14]=XGetImage(xdisplay,pixmap[linpage],rx3,ry3+EPANTSY-1,rx3+3,ry3+ENDBODY-7*(numimg3==0)-5*(numimg3==1),AllPlanes,ZPixmap);
lines3[15]=XGetImage(xdisplay,pixmap[linpage],rx3+ESHIRTX-5,ry3+EPANTSY-1,rx3+ESHIRTX-4+2*(numimg3==4),
...
/*square under shoe*/
#ifdef Linux
lines3[16]=XGetImage(xdisplay,pixmap[linpage],rx3+(ESHIRTX-8)*(numimg3==1||numimg3==3||numimg3==7)+
...
{
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[0],0,0,hx1,hy1+skin[2]*HF*(mode!=1)+
	  (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),4,HMAN+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[7],0,0,hx1+ECHX-5-skin[7]*2,hy1+skin[2]*HF*(mode!=4)+
	     (!(skin[2]==0&&mode==1)&&(skin[2]==0||mode==4))*(NOSEY+7),4,HMAN+1);
...
if (skin[7]==0)    /*dress*/
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[10],0,0,hx1+2,hy1+skin[2]*HF*(mode!=1)+
	 (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),1,HMAN+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[11],0,0,hx1+ECHX-6,hy1+skin[2]*HF*(mode!=4)+
	     (!(skin[2]==0&&mode==1)&&(skin[2]==0||mode==4))*(NOSEY+7),1,HMAN+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[12],0,0,hx1+3,hy1+skin[2]*HF*(mode!=1)+
	 (!(skin[2]==0&&mode==4)&&(skin[2]==0||mode==1))*(NOSEY+7),1,HMAN);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[13],0,0,hx1+ECHX-7,hy1+skin[2]*HF*(mode!=4)+
	     (!(skin[2]==0&&mode==1)&&(skin[2]==0||mode==4))*(NOSEY+7),1,HMAN);
...
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[1],0,0,hx1,hy1,3,2);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[2],0,0,hx1+ECHX-7,hy1,3,2);
...
if (skin[2]!=2 || (skin[2]==2 && mode!=2))
  ...
  if (mode !=2 || skin[2]<2)              /*neck lines*/
    {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[3],0,0,hx1+3,hy1+BSHIRTY-4,5,2);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[4],0,0,hx1+ESHIRTX-7,hy1+BSHIRTY-4,5,2);
...
if (mode==1||(skin[2]==0&&mode!=4))
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[5],0,0,hx1,hy1,3,NOSEY+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[8],0,0,hx1,hy1+NOSEY,2,BSHIRTY-NOSEY);
#endif
#ifdef DOS
...
if (mode==4||(skin[2]==0&&mode!=1))
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[6],0,0,hx1+ESHIRTX-3,hy1,3,NOSEY+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[9],0,0,hx1+ESHIRTX-3,hy1+NOSEY,2,BSHIRTY-NOSEY);
...
/*shoes*/
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines[14],0,0,hx1,hy1+EPANTSY-1,5,ENDBODY-EPANTSY-16);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[15],0,0,hx1+ESHIRTX-5,hy1+EPANTSY-1,5,ENDBODY-EPANTSY-16);
XPutImage(xdisplay,pixmap[linpage],xgc,lines[16],0,0,hx1+(ESHIRTX-8)*(numimg==1||numimg==3||numimg==7)+
	 4*(numimg==6||numimg==4)+(ESHIRTX-4)*(numimg==5),
	 hy1+ENDBODY-4,4,ENDBODY);
...
{
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[0],0,0,rx3,ry3+skin3[2]*HF*(mode3!=1)+
	  (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),2+skin3[7]*2,HMAN);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[7],0,0,rx3+ECHX-5-skin3[7]*2,ry3+skin3[2]*HF*(mode3!=4)+
	     (!(skin3[2]==0&&mode3==1)&&(skin3[2]==0||mode3==4))*(NOSEY+7),2+skin3[7]*2,HMAN);
...
if (skin3[7]==0)    /*dress*/
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[10],0,0,rx3+2,ry3+skin3[2]*HF*(mode3!=1)+
	 (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),1,HMAN-DF+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[11],0,0,rx3+ECHX-6,ry3+skin3[2]*HF*(mode3!=4)+
	     (!(skin3[2]==0&&mode3==1)&&(skin3[2]==0||mode3==4))*(NOSEY+7),1,HMAN-DF+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[12],0,0,rx3+3,ry3+skin3[2]*HF*(mode3!=1)+
	 (!(skin3[2]==0&&mode3==4)&&(skin3[2]==0||mode3==1))*(NOSEY+7),1,HMAN-DF2+1);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[13],0,0,rx3+ECHX-7,ry3+skin3[2]*HF*(mode3!=4)+
	     (!(skin3[2]==0&&mode3==1)&&(skin3[2]==0||mode3==4))*(NOSEY+7),1,HMAN-DF2+1);
...
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[1],0,0,rx3,ry3,3,2);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[2],0,0,rx3+ECHX-7,ry3,3,2);
...
if (skin3[2]!=2 || (skin3[2]==2 && mode3!=2))
  ...
  if (mode3 !=2 || skin3[2]<2)              /*neck lines*/
    {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[3],0,0,rx3+3,ry3+BSHIRTY-4,5,2);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[4],0,0,rx3+ESHIRTX-7,ry3+BSHIRTY-4,5,2);
...
if (mode3==1||(skin3[2]==0&&mode3!=4))
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[5],0,0,rx3,ry3,2,NOSEY);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[8],0,0,rx3,ry3+NOSEY,1,BSHIRTY-NOSEY);
...
if (mode3==4||(skin3[2]==0&&mode3!=1))
  {
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[6],0,0,rx3+ESHIRTX-3,ry3,2,NOSEY);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[9],0,0,rx3+ESHIRTX-3,ry3+NOSEY,2,BSHIRTY-NOSEY);
...
/*shoes*/
#ifdef Linux
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[14],0,0,rx3,ry3+EPANTSY-1,5,ENDBODY-EPANTSY-16);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[15],0,0,rx3+ESHIRTX-5,ry3+EPANTSY-1,5,ENDBODY-EPANTSY-16);
XPutImage(xdisplay,pixmap[linpage],xgc,lines3[16],0,0,rx3+(ESHIRTX-8)*(numimg3==1||numimg3==3||numimg3==7)+
	 4*(numimg3==6||numimg3==4)+(ESHIRTX-4)*(numimg3==5),
	 ry3+ENDBODY-4,4,ENDBODY-2);
...
for(c=0;c<8;c++)    /*get character images*/
   {
#ifdef Linux
  man[c]=XGetImage(xdisplay,pixmap[linpage],SCHX+c*F,SCHY,SCHX+WMAN+c*F,SCHY+HMAN,AllPlanes,ZPixmap);
#endif
#ifdef DOS
...
for(c=0;c<8;c++)    /*get character images*/
   {
#ifdef Linux
   robot[c]=XGetImage(xdisplay,pixmap[linpage],SCHX+c*F,SCHY,SCHX+WMAN+c*F,SCHY+HMAN,AllPlanes,ZPixmap);
#endif
#ifdef DOS
...
{
#ifdef Linux
   car[c]=XGetImage(xdisplay,pixmap[linpage],0,0,136,48,AllPlanes,ZPixmap);
#endif
#ifdef DOS
...
{
#ifdef Linux
   road[c]=XGetImage(xdisplay,pixmap[linpage],0,0,72,1,AllPlanes,ZPixmap);
#endif
#ifdef DOS
...
{
#ifdef Linux
   spike[c]=XGetImage(xdisplay,pixmap[linpage],0,0,8,24,AllPlanes,ZPixmap);
#endif
#ifdef DOS
...
for (c=0;c<4;c++)
  ...
  off=38*c;
#ifdef Linux
lines[off+17]=XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1],obj[c+24].p[0]+6,obj[c+24].p[1],AllPlanes,ZPixmap);
lines[off+18]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+1,obj[c+24].p[0]+1,obj[c+24].p[1]+1,AllPlanes,ZPixmap);
lines[off+19]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+3,obj[c+24].p[0]+1,obj[c+24].p[1]+3,AllPlanes,ZPixmap);
lines[off+20]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+4,obj[c+24].p[0]+6,obj[c+24].p[1]+4,AllPlanes,ZPixmap);
lines[off+21]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+5,obj[c+24].p[0]+15,obj[c+24].p[1]+7,AllPlanes,ZPixmap);
lines[off+22]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+8,obj[c+24].p[0]+12,obj[c+24].p[1]+8,AllPlanes,ZPixmap);
lines[off+23]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+9,obj[c+24].p[0]+9,obj[c+24].p[1]+9,AllPlanes,ZPixmap);
lines[off+24]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+10,obj[c+24].p[0]+8,obj[c+24].p[1]+10,AllPlanes,ZPixmap);
lines[off+25]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+11,obj[c+24].p[0]+7,obj[c+24].p[1]+11,AllPlanes,ZPixmap);
lines[off+26]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+12,obj[c+24].p[0]+6,obj[c+24].p[1]+12,AllPlanes,ZPixmap);
lines[off+27]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+13,obj[c+24].p[0]+5,obj[c+24].p[1]+17,AllPlanes,ZPixmap);
lines[off+28]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+18,obj[c+24].p[0]+6,obj[c+24].p[1]+18,AllPlanes,ZPixmap);
lines[off+29]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+19,obj[c+24].p[0]+7,obj[c+24].p[1]+19,AllPlanes,ZPixmap);
lines[off+30]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+20,obj[c+24].p[0]+8,obj[c+24].p[1]+20,AllPlanes,ZPixmap);
lines[off+31]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+21,obj[c+24].p[0]+9,obj[c+24].p[1]+21,AllPlanes,ZPixmap);
lines[off+32]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+22,obj[c+24].p[0]+12,obj[c+24].p[1]+22,AllPlanes,ZPixmap);
lines[off+33]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+23,obj[c+24].p[0]+52,obj[c+24].p[1]+23,AllPlanes,ZPixmap);
lines[off+34]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1]+24,obj[c+24].p[0]+56,obj[c+24].p[1]+24,AllPlanes,ZPixmap);
lines[off+35]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+26,obj[c+24].p[1],obj[c+24].p[0]+56,obj[c+24].p[1],AllPlanes,ZPixmap);
lines[off+36]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+31,obj[c+24].p[1]+1,obj[c+24].p[0]+55,obj[c+24].p[1]+1,AllPlanes,ZPixmap);
lines[off+37]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+32,obj[c+24].p[1]+2,obj[c+24].p[0]+53,obj[c+24].p[1]+2,AllPlanes,ZPixmap);
lines[off+38]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+31,obj[c+24].p[1]+3,obj[c+24].p[0]+51,obj[c+24].p[1]+3,AllPlanes,ZPixmap);
lines[off+39]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+26,obj[c+24].p[1]+4,obj[c+24].p[0]+49,obj[c+24].p[1]+4,AllPlanes,ZPixmap);
lines[off+40]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+17,obj[c+24].p[1]+5,obj[c+24].p[0]+47,obj[c+24].p[1]+5,AllPlanes,ZPixmap);
lines[off+41]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+17,obj[c+24].p[1]+6,obj[c+24].p[0]+45,obj[c+24].p[1]+6,AllPlanes,ZPixmap);
lines[off+42]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+17,obj[c+24].p[1]+7,obj[c+24].p[0]+43,obj[c+24].p[1]+7,AllPlanes,ZPixmap);
lines[off+43]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+20,obj[c+24].p[1]+8,obj[c+24].p[0]+39,obj[c+24].p[1]+8,AllPlanes,ZPixmap);
lines[off+44]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+23,obj[c+24].p[1]+9,obj[c+24].p[0]+37,obj[c+24].p[1]+9,AllPlanes,ZPixmap);
lines[off+45]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+24,obj[c+24].p[1]+10,obj[c+24].p[0]+35,obj[c+24].p[1]+10,AllPlanes,ZPixmap);
lines[off+46]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+25,obj[c+24].p[1]+11,obj[c+24].p[0]+33,obj[c+24].p[1]+11,AllPlanes,ZPixmap);
lines[off+47]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+26,obj[c+24].p[1]+12,obj[c+24].p[0]+31,obj[c+24].p[1]+12,AllPlanes,ZPixmap);
lines[off+48]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+27,obj[c+24].p[1]+13,obj[c+24].p[0]+29,obj[c+24].p[1]+13,AllPlanes,ZPixmap);
lines[off+49]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+27,obj[c+24].p[1]+17,obj[c+24].p[0]+31,obj[c+24].p[1]+17,AllPlanes,ZPixmap);
lines[off+50]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+26,obj[c+24].p[1]+18,obj[c+24].p[0]+34,obj[c+24].p[1]+18,AllPlanes,ZPixmap);
lines[off+51]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+25,obj[c+24].p[1]+19,obj[c+24].p[0]+38,obj[c+24].p[1]+19,AllPlanes,ZPixmap);
lines[off+52]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+24,obj[c+24].p[1]+20,obj[c+24].p[0]+41,obj[c+24].p[1]+20,AllPlanes,ZPixmap);
lines[off+53]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+23,obj[c+24].p[1]+21,obj[c+24].p[0]+45,obj[c+24].p[1]+21,AllPlanes,ZPixmap);
lines[off+54]=  XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0]+20,obj[c+24].p[1]+22,obj[c+24].p[0]+49,obj[c+24].p[1]+22,AllPlanes,ZPixmap);
#endif
...
#ifdef Linux
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+17],0,0,obj[c+24].p[0],obj[c+24].p[1],7,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+18],0,0,obj[c+24].p[0],obj[c+24].p[1]+1,2,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+19],0,0,obj[c+24].p[0],obj[c+24].p[1]+3,2,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+20],0,0,obj[c+24].p[0],obj[c+24].p[1]+4,7,3);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+21],0,0,obj[c+24].p[0],obj[c+24].p[1]+5,16,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+22],0,0,obj[c+24].p[0],obj[c+24].p[1]+8,13,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+23],0,0,obj[c+24].p[0],obj[c+24].p[1]+9,10,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+24],0,0,obj[c+24].p[0],obj[c+24].p[1]+10,9,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+25],0,0,obj[c+24].p[0],obj[c+24].p[1]+11,8,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+26],0,0,obj[c+24].p[0],obj[c+24].p[1]+12,7,5);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+27],0,0,obj[c+24].p[0],obj[c+24].p[1]+13,6,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+28],0,0,obj[c+24].p[0],obj[c+24].p[1]+18,7,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+29],0,0,obj[c+24].p[0],obj[c+24].p[1]+19,8,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+30],0,0,obj[c+24].p[0],obj[c+24].p[1]+20,9,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+31],0,0,obj[c+24].p[0],obj[c+24].p[1]+21,10,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+32],0,0,obj[c+24].p[0],obj[c+24].p[1]+22,13,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+33],0,0,obj[c+24].p[0],obj[c+24].p[1]+23,53,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+34],0,0,obj[c+24].p[0],obj[c+24].p[1]+24,57,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+35],0,0,obj[c+24].p[0]+26,obj[c+24].p[1],31,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+36],0,0,obj[c+24].p[0]+31,obj[c+24].p[1]+1,25,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+37],0,0,obj[c+24].p[0]+32,obj[c+24].p[1]+2,22,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+38],0,0,obj[c+24].p[0]+31,obj[c+24].p[1]+3,21,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+39],0,0,obj[c+24].p[0]+26,obj[c+24].p[1]+4,24,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+40],0,0,obj[c+24].p[0]+17,obj[c+24].p[1]+5,31,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+41],0,0,obj[c+24].p[0]+17,obj[c+24].p[1]+6,29,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+42],0,0,obj[c+24].p[0]+17,obj[c+24].p[1]+7,27,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+43],0,0,obj[c+24].p[0]+20,obj[c+24].p[1]+8,20,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+44],0,0,obj[c+24].p[0]+23,obj[c+24].p[1]+9,15,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+45],0,0,obj[c+24].p[0]+24,obj[c+24].p[1]+10,12,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+46],0,0,obj[c+24].p[0]+25,obj[c+24].p[1]+11,9,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+47],0,0,obj[c+24].p[0]+26,obj[c+24].p[1]+12,6,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+48],0,0,obj[c+24].p[0]+27,obj[c+24].p[1]+13,3,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+49],0,0,obj[c+24].p[0]+27,obj[c+24].p[1]+17,5,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+50],0,0,obj[c+24].p[0]+26,obj[c+24].p[1]+18,9,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+51],0,0,obj[c+24].p[0]+25,obj[c+24].p[1]+19,14,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+52],0,0,obj[c+24].p[0]+24,obj[c+24].p[1]+20,18,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+53],0,0,obj[c+24].p[0]+23,obj[c+24].p[1]+21,23,1);
  XPutImage(xdisplay,pixmap[linpage],xgc,lines[off+54],0,0,obj[c+24].p[0]+20,obj[c+24].p[1]+22,30,1);
#endif
...
for(c=0;c<4;c++)
  {
#ifdef Linux
   heli[c]=XGetImage(xdisplay,pixmap[linpage],obj[c+24].p[0],obj[c+24].p[1],obj[c+24].p[0]+58,obj[c+24].p[1]+24,AllPlanes,ZPixmap);
#endif
#ifdef DOS
